...
**모호할 때는 해법보다 명료화가 먼저다 (P·Q — 불확실한 일을 기획으로 바꿀 때 특히 중요).** 요청이 불확실하면 곧장 해법을 발산(심의)하지 마라 — 문제가 덜 잡힌 채 발산하면 **잘못 세운 문제에 정교한 답**을 내게 된다. 먼저 문제·목표가 잡혔는지 보고(P), 안 잡혔으면 해법으로 넘어가기 전에 **"결정 질문 묶음"을 1차 산출로 낸다(Q).** 모호함이 크면 완성된 기획이 아니라 그 질문들 자체가 이번 산출물이다.
