...
flowchart TD
    A["A. 대상·요청을 받는다"]
    B{"B. 실행 전 질문<br/>무엇이 품질인가 (성공 기준·범위·중요 사용자)"}
