...
> 상태: v0.2.0 · 첫 실전(hardware-team-system loop-1/2)을 거쳐 다듬는 중. 실제로 진짜 문제를 찾고 거짓 경보를 재현으로 걸러냄을 확인했다(완전 성숙 전). 이 스킬에 대한 변경은 `CHANGES.md`에만 As-Is/To-Be·역기능 형식으로 기록한다.
